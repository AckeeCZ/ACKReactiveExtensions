...
public func <~> (property: MutableProperty<String?>, textField: UITextField) {
    textField.reactive.text <~ property.producer.filter { [unowned textField] in textField.text != $0 }
...
public func <~> (property: MutableProperty<String?>, textView: UITextView) {
    textView.reactive.text <~ property.producer.filter { [unowned textView] in textView.text != $0 }
